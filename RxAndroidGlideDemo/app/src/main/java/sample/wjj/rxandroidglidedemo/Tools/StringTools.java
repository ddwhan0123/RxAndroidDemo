...
public class StringTools {
    ...
    public String htmlEscapeCharsToString(String source) {
        ...
        return StringTools.getInstance().isEmpty(source)
                ? source
                : source.replaceAll("&lt;", "<")
                .replaceAll("&gt;", ">")
                .replaceAll("&amp;", "&")
    ...
    public String replaceBlanktihuan(String str) {
     ...
     * 如果字符串是null或者空就返回""
     */
    public String filterEmpty(String string) {
        return StringTools.getInstance().isNotEmpty(string) ? string : "";
    }
    ...
    private char[] getChars(char[] chars, int startIndex) {
     ...
     * 是否全是数字
     */
    public boolean isAllDigital(char[] chars) {
        boolean result = true;
        for (int w = 0; w < chars.length; w++) {
     ...
     */
    public String removeChar(String string, int index, char ch) {
        String result = null;
        char[] chars = string.toCharArray();
     ...
     */
    public String filterBlank(String string) {
        if ("".equals(string)) {
            return null;
        } else {
            return string;
     ...
     * @return 新的字符串
     */
    public String toLowerCase(String str, int beginIndex, int endIndex) {
     ...
     * @return 新的字符串
     */
    public String toUpperCase(String str, int beginIndex, int endIndex) {
        return str.replaceFirst(str.substring(beginIndex, endIndex),
                str.substring(beginIndex, endIndex)
     ...
     */
    public boolean startsWithIgnoreCase(String sourceString, String newString) {
     ...
     * @param newString    一个特定的字符串
     */
    public boolean endsWithIgnoreCase(String sourceString, String newString) {
        int newLength = newString.length();
        int sourceLength = sourceString.length();
        if (newLength == sourceLength) {
            return newString.equalsIgnoreCase(sourceString);
     ...
     */
    public String checkLength(String string, int maxLength, String appendString) {
     ...
     */
    public String checkLength(String string, int maxLength) {
